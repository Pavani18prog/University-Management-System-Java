...
public class StudentFeeForm extends JFrame implements ActionListener {
    ...
    StudentFeeForm(){
        ...
        String course[]={"BTech","BBA","BCA","Bsc","BA","BE","Msc","M.Tech","MBA","MCA","M.com"};
        ...
        String branch[]={"CSE","ECE","EEE","Mech","Civil","IT","BioTechnology","Aeronautical","FoodTech"};
        ...
        submit.setFont(new Font("Roman",Font.BOLD,16));
        add(submit);
        ...
        cancel.setFont(new Font("Roman",Font.BOLD,16));
        add(cancel);
        ...
        back.setFont(new Font("Roman",Font.BOLD,16));
        add(back);
